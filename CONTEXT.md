...
### Notifications
Multi-channel transactional notification system — push (Parent mobile via Firebase Cloud Messaging; Provider mobile companion via FCM; Provider web portal via VAPID web push, best-effort), email (all surfaces, via SendGrid), SMS (all surfaces, via Twilio).
